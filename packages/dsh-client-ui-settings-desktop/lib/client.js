window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function DesktopSettings() { var [tab,setTab]=useState("plugins"); return h("section",{className:"dshd"},h("div",{className:"dshd-head"},h("div",null,h("h2",null,"个人扩展"),h("p",{className:"dshd-sub"},"管理你自行安装的插件和 Desktop 命令行入口。"))),h("div",{className:"dshd-tabs"},h("button",{className:"dshd-tab","data-active":tab==="plugins",onClick:()=>setTab("plugins")},"个人安装"),h("button",{className:"dshd-tab","data-active":tab==="command",onClick:()=>setTab("command")},"命令行")),tab==="plugins"?h(PersonalPlugins):h(CommandLine)); }
